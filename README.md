...
*   **AI-Powered Sorting:** Use Gemini AI to categorize even the most obscure apps based on their package names and metadata.
...
3.  **AI Sort:** For apps that are hard to categorize, use the "AI Sort" button to let Gemini AI handle the heavy lifting.
...
A: Your inventory is stored locally in your browser's session. If you use the "AI Sort" feature, only the app names and package names are sent to the Gemini API for categorization.

**Q: Why are some apps marked as "Other"?**
A: If the automatic mapping doesn't recognize the app, it defaults to "Other". You can use the "AI Sort" button or manually assign a category in the app details.
